...
Jarvis is a project for developing a robot assistant powered, for now, with Chat-GPT-4. That is in progress. Next is vision/constant environment feedback so it never "turns off". Continual work in progress.
